...
import projects from "../data/projects"; // Make sure this file exports your 10 projects
  ...
  return (
    <section id="projects" className="relative py-16 px-4 sm:px-8 bg-[#0b1a3b] text-white min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 text-center mb-10">
        <h2 className="text-4xl font-bold mb-2 sticky top-0 bg-[#0b1a3b] z-20">Projects</h2>
