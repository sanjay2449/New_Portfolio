        ...
        >
          {certificates.map((certificate, index) => (
            ...
            >
              ...
              />
              <h3 className="text-xl font-semibold text-blue-400 mb-2">{certificate.title}</h3>
              <p className="text-sm text-gray-300 mb-3 line-clamp-3">{certificate.description}</p>
